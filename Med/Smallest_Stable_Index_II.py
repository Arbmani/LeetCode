...
if __name__ == "__main__":
    print(f"Expected answer is {3}, Mine is {Solution().firstStableIndex(nums = [5,0,1,4], k = 3)}")

    print(f"Expected answer is {-1}, Mine is {Solution().firstStableIndex(nums = [3,2,1], k = 1)}")

    print(f"Expected answer is {0}, Mine is {Solution().firstStableIndex(nums = [0], k = 0)}")